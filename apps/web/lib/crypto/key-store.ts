...
import type { StoredApiKey } from '@ai-sales-trainer/shared-types';

const DB_NAME = 'ai-sales-trainer';
...
export async function getApiKey(id: string): Promise<StoredApiKey | undefined> {
  const db = await openDB();
  return new Promise((resolve, reject) => {
